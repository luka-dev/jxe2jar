/*
 * @(#)src/demo/jfc/Java2D/src/java2d/Intro.java, dsdev, dsdev 1.10
 * ===========================================================================
    ...
    static class Surface extends JPanel implements Runnable {
		...
		return;
            ...
            if (bimg == null || bimg.getWidth() != d.width || bimg.getHeight() != d.height) {
                GraphicsConfiguration gc = getGraphicsConfiguration(); /*ibm@56347*/
                if (gc == null) {                                      /*ibm@56347*/
                    return;                                            /*ibm@56347*/
                }                                                      /*ibm@56347*/
                bimg = gc.createCompatibleImage(d.width, d.height);    /*ibm@56347*/ 
                // reset future scenes
        ...
        static class DdE implements Part {
            ...
            public void step(int w, int h) {
                if (bimg == null || (inc >= list.size())) {   /*ibm@56347*/
                    int biw = Surface.bimg.getWidth();
                    int bih = Surface.bimg.getHeight();
                    bimg = new BufferedImage(biw, bih, BufferedImage.TYPE_INT_RGB);
                    createShuffledLists();
