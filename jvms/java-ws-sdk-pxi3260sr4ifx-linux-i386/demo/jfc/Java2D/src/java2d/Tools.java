/*
 * @(#)src/demo/jfc/Java2D/src/java2d/Tools.java, dsdev, dsdev 1.9
 * ===========================================================================
...
//        setBackground(Color.gray);
    ...
    public void run() {
        ...
        if (surface.animating != null && surface.animating.thread != null) {
            stopped = true;
            Java2Demo.doClickOnDispatchThread(startStopB);
        }
    ...
    static class ToggleIcon implements Icon, Runnable {
        ...
        public void run() {
            ...
            if (tools.focus && thread != null) {
                Java2Demo.doClickOnDispatchThread(tools.toggleB);
            }
            thread = null;
        }
    }
