/*
 * @(#)src/demo/jfc/Java2D/src/java2d/demos/Clipping/Intersection.java, dsdev, dsdev 1.9
 * ===========================================================================
...
/*
 * @(#)Intersection.java	1.24 02/06/13
 */
...
public class Intersection extends AnimatingControlsSurface {
    ...
    static class DemoControls extends CustomControls implements ActionListener {
        ...
        public void run() {
            ...
            while (thread == me) {
                if (demo.threeSixty) {
                    java2d.Java2Demo.doClickOnDispatchThread((JButton) toolbar.getComponentAtIndex(1));
