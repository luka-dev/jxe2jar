/*
 * @(#)src/demo/jfc/Java2D/src/java2d/demos/Mix/BezierScroller.java, dsdev, dsdev 1.10
 * ===========================================================================
        ...
        public void run() {
            ...
            while (thread == me) {
                ...
                if (demo.buttonToggle) {
                    java2d.Java2Demo.doClickOnDispatchThread((AbstractButton) toolbar.getComponentAtIndex(i++%2));
