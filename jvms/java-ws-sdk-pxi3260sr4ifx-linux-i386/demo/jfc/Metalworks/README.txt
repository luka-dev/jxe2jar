...
instructions for the Java 2 SDK. CLASSPATH should also specify the
current directory in order to locate the ./resources subdirectory.
...
7. Selecting from the Drag menu allows you to change the dragging style of the 
   JInternalFrames( ie. email composition window, In-Box window & Help window).
